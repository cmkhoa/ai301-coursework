...
I'm a student who has shipped several web and mobile projects: Python
scripting and small backends, JavaScript/TypeScript front ends, and Swift
for iOS. I'm comfortable reading unfamiliar code and reproducing bugs, and
I've done competitive programming in C++, so algorithmic fixes don't scare
me. I want to get better at full-stack web work (React/Node-style
codebases) and at writing changes a reviewer can merge without back-and-
forth. I'd prefer bounded bug fixes or small features over pure copy/docs
edits, and I'd rather avoid issues that require heavy DevOps or
infrastructure setup to reproduce.
